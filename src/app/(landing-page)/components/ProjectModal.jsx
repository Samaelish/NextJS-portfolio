      ...
      >
        ...
        <div className='flex flex-col md:flex-row gap-6'>
          ...
          <div className='absolute top-1/2 -translate-y-1/2 flex justify-between w-11/12 max-w-4xl'>
            <button
              onClick={onPrev}
              className='bg-gray-800/50 hover:text-primary-400 rounded-full p-2 hover:bg-gray-800/70 transition-colors -translate-x-full'
            >
              <ChevronLeft size={24} />
            </button>
            <button
              onClick={onNext}
              className='bg-gray-800/50 hover:text-primary-400 rounded-full p-2 hover:bg-gray-800/70 transition-colors -translate-x-[120%]'
            >
